# Countdown - Create a function 
# that accepts a number as an 
# input. Return a new list 
# that counts down by one, 
...
def countdown_num(n):
    ...
    for i in range(n,-1,-1):
        ...
        n-=1
    return list
print(countdown_num(5))

# Print and Return - 
# Create a function that will receive a 
# list with two numbers. Print the first 
# value and return the second.
# Example: print_and_return([1,2]) 
